...
$routes->post('/createPegawai', 'PegawaiControllers::create');
$routes->post('/updatePegawai', 'PegawaiControllers::update');
$routes->post('/getByParamsPegawai', 'PegawaiControllers::getByParams');
$routes->get('/deletePegawai', 'PegawaiControllers::delete');
